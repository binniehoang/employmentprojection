"""
Exploratory Data Analysis (EDA) script for the cleaned employment projections dataset.

This script loads the cleaned data, displays basic statistics, checks for missing values, plots distributions of key numeric columns, and generates a correlation heatmap.
"""
...
def main():
    """
    Main EDA workflow: loads data, prints info, plots distributions, and saves figures.
    """
